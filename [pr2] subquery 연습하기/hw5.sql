...
SELECT driver FROM Drivers WHERE constructor 
IN (SELECT c1.constructor FROM Constructors c1, Constructors c2 WHERE c1.height=c2.height and c1.width>c2.width);
